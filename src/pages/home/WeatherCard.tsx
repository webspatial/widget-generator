...
function WindSVG() {
  return <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_387_7593)">
      <path d="M2.5 7.49935L7.50004 7.4993C8.42049 7.4993 9.16667 6.75312 9.16667 5.83266V5.83266C9.16667 4.9122 8.42048 4.16602 7.50002 4.16602H6.94444" stroke="white" strokeWidth="1.25" strokeLinecap="round" />
      <path d="M2.5 12.4993L10.4167 12.4994C11.5673 12.4994 12.5 13.4321 12.5 14.5827V14.5827C12.5 15.7333 11.5673 16.666 10.4167 16.666H10.1923" stroke="white" strokeWidth="1.25" strokeLinecap="round" />
      <path d="M2.5 10L14.8469 9.99962C15.8606 9.99959 16.6907 9.19384 16.7208 8.18061V8.18061C16.7523 7.12379 15.9041 6.25 14.8468 6.25H13.6302" stroke="white" strokeWidth="1.25" strokeLinecap="round" />
    </g>
    <defs>
...
export default function WeatherCard({
  ...
  const onRemoveClicked = (evt: React.MouseEvent<HTMLDivElement>) => {
    const rect = ref2deleteIcon.current?.getBoundingClientRect()
