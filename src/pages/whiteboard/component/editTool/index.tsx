...
export default function EditTool(props:{showTool:(show:boolean) => void}) {
  ...
  function IconClear({ className }:{ className?:string }){
    return <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <g clipPath="url(#clip0_255_11293)">
            <g opacity="0.15" clipPath="url(#clip1_255_11293)">
                <rect x="7.05" y="4.05" width="9.9" height="15.9" rx="1.95" stroke="#51F5FF" strokeWidth="0.1"/>
                <rect x="19.95" y="7.05" width="9.9" height="15.9" rx="1.95" transform="rotate(90 19.95 7.05)" stroke="#51F5FF" strokeWidth="0.1"/>
                <rect x="5.05" y="5.05" width="13.9" height="13.9" rx="1.95" stroke="#FFEA7E" strokeWidth="0.1"/>
                <circle cx="12" cy="12" r="7.95" stroke="#FF4BC2" strokeWidth="0.1"/>
  ...
  function IconUndo({ className, style }:{ className?:string, style?:React.CSSProperties  }){
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M7.5496 11.6616L10.9364 15.5L9.43672 16.8232L4 10.6616L8.99555 5L10.4952 6.32324L7.5496 9.66162H12.3336C16.1996 9.66162 19.3336 12.7956 19.3336 16.6616V18.6616H17.3336V16.6616C17.3336 13.9002 15.095 11.6616 12.3336 11.6616H7.5496Z" fill="white"/>
    </svg>
  ...
  function IconErase({ className }:{ className?:string }){
    ...
    {/* </mask> */}
    <rect x="12.842" y="3" width="10.1228" height="13.9188" rx="1" transform="rotate(45 12.842 3)" stroke="white" strokeWidth="3" mask="url(#path-1-inside-1_255_11310)"/>
    <path d="M7.70439 10.5925L12.8429 15.5265" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>    
  }
  ...
  function IconSubmit({ className }:{ className?:string }){
    return <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <path d="M6 12L10.6667 16L18 8" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
