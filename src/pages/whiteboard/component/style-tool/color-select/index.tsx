...
function IconLineWidth({ className, width }: { className?: string, width: number }) {
    return (<>
        ...
        {width === 2 && <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            <path d="M18.0526 12.8354C18.6416 12.3554 19.5104 12.3903 20.0595 12.9389C20.6085 13.4879 20.643 14.3566 20.163 14.9457L20.0595 15.06L15.0595 20.06C14.4737 20.6458 13.5241 20.6458 12.9384 20.06C12.353 19.4742 12.3527 18.5246 12.9384 17.9389L17.9384 12.9389L18.0526 12.8354ZM15.0546 3.83637C15.6437 3.35631 16.5124 3.39088 17.0614 3.93988C17.6102 4.48891 17.645 5.35764 17.1649 5.94672L17.0614 6.06098L6.06141 17.061C5.47569 17.6467 4.52612 17.6466 3.94032 17.061C3.35453 16.4752 3.35453 15.5257 3.94032 14.9399L14.9403 3.93988L15.0546 3.83637Z" fill="white"/>
        </svg>}
